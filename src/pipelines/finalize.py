...
if __name__ == "__main__":
     ...
     logging.info(f"Filtered relevant articles classified as carve-outs with shape: {df.shape}")
     if args.test:
     ...
     full_df = df[['source_name','title','article_fragment','carve_out_stage', 'reasoning']].merge(df_results, left_index=True, right_index=True, how='left', suffixes=['_original', '_new']) #type: ignore
